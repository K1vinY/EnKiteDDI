...
```bibtex
@article{enkiteddi2024,
  title={EnKiteDDI: Enhanced KiteDDI with SemMedDB Features for Drug-Drug Interaction Prediction},
  author={Your Name},
...
Also please cite the original KiteDDI paper:

```bibtex
@article{kiteddi2023,
  title={KiteDDI: A knowledge graph integrated Transformer model for Drug-Drug Interaction prediction},
  author={Tamir, Azwad},
  journal={Journal Name},
  year={2023}
}
