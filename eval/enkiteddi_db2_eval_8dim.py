...
def parse_arguments():
    ...
    parser.add_argument('--data', '-d', type=str, default='../../data/tup_list_db2kges_transe.pkl.pkl', help='train corpus (.csv)')
...
def print_results(name, loss, acc, f1_weighted, f1_macro, mcc, 
    ...
    print('='*80)
    print(f'ENKITEDDI DB2 8-dim: {name} Results:')
    print('-'*80)
...
def main():
    ...
    print('='*80)
    print('EnKiteDDI DB2 - Ablation Study: 8-dim SemMedDB Features Evaluation')
    print('EnKiteDDI DB2 - Ablation Study: 8-dim SemMedDB Features Evaluation (has_relation + 6 relation types + normalized_count)')
    print('='*80)
    ...
    kge_path = '../../data/db2_kges_transe_new_short.pkl'
    ...
    semmeddb_path = '../../data/semmeddb_features_db2_8dim.pkl'
    ...
    model_path = 'trained_models/model_enkiteddi_db2_8dim_best.pkl'
    ...
    print('\n')
    print('='*80)
    print('SUMMARY TABLE - EnKiteDDI DB2 8-dim (Ablation Study)')
    print('='*80)
    ...
    with open(r"./result/r_enkiteddi_db2_8dim.pkl", "wb") as output_file:
        pickle.dump(all_results, output_file)
    
    print(f'\nResults saved to: ./result/r_enkiteddi_db2_8dim.pkl')
