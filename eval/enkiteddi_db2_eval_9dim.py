...
def print_results(name, loss, acc, f1_weighted, f1_macro, mcc, 
    ...
    print('='*80)
    print(f'ENKITEDDI v2 DB2: {name} Results:')
    print('-'*80)
...
def main():
    ...
    print('='*80)
    print('EnKiteDDI v2 DB2 Evaluation')
    print('Enhanced with SemMedDB Features (9-dim)')
    print('='*80)
    ...
    semmeddb_path = '../../data/semmeddb_features_db2_9dim.pkl'
    ...
    model_path = 'trained_models/model_enkiteddi_db2_9dim_best.pkl'
    ...
    print('\n')
    print('='*80)
    print('SUMMARY TABLE - EnKiteDDI v2 DB2 (with SemMedDB Features)')
    print('='*80)
    ...
    with open(r"./result/r_enkiteddi_db2_v2.pkl", "wb") as output_file:
        pickle.dump(all_results, output_file)
    
    print(f'\nResults saved to: ./result/r_enkiteddi_db2_v2.pkl')
