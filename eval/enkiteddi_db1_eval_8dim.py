...
def print_results(name, loss, acc, f1_weighted, f1_macro, mcc, 
    ...
    print('='*80)
    print(f'ENKITEDDI 8-dim: {name} Results:')
    print('-'*80)
...
def main():
    ...
    print('='*80)
    print('EnKiteDDI - Ablation Study: 8-dim SemMedDB Features Evaluation')
    print('='*80)
    ...
    semmeddb_path = '../../data/semmeddb_features_db1_8dim.pkl'
    ...
    model_path = 'trained_models/model_enkiteddi_db1_8dim_best.pkl'
    ...
    print('\n')
    print('='*80)
    print('SUMMARY TABLE - EnKiteDDI 8-dim DB1 (Ablation Study)')
    print('='*80)
    ...
    with open(r"./result/r_enkiteddi_db1_8dim.pkl", "wb") as output_file:
        pickle.dump(all_results, output_file)
    
    print(f'\nResults saved to: ./result/r_enkiteddi_db1_8dim.pkl')
